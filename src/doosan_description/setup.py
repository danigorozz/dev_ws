...
package_name = 'doosan_description'
...
setup(
    ...
    entry_points={
        'console_scripts': [
                'trajectory_points_topic = doosan_description.joint_points_topic:main',
                'trajectory_points_act_server = doosan_description.joint_points_act_service:main',
        ],
    },
)

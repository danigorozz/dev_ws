...
#include "ros2_data/msg/detail/joint_pose__rosidl_typesupport_fastrtps_c.h"
...
using _JointPose__ros_msg_type = ros2_data__msg__JointPose;
...
static uint32_t _JointPose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_data__msg__JointPose(
...
static size_t _JointPose__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ros2_data__msg__JointPose(
    full_bounded, 0);
}

...
{
  return max_serialized_size_ros2_data__action__MoveXYZ_Goal(
    full_bounded, 0);
}
...
{
  return max_serialized_size_ros2_data__action__MoveXYZ_Result(
    full_bounded, 0);
}
...
{
  return max_serialized_size_ros2_data__action__MoveXYZ_Feedback(
    full_bounded, 0);
}
...
{
  return max_serialized_size_ros2_data__action__MoveXYZ_SendGoal_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_ros2_data__action__MoveXYZ_SendGoal_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_ros2_data__action__MoveXYZ_GetResult_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_ros2_data__action__MoveXYZ_GetResult_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_ros2_data__action__MoveXYZ_FeedbackMessage(
    full_bounded, 0);
}

...
static size_t _MoveXYZW_Goal__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ros2_data__action__MoveXYZW_Goal(
    full_bounded, 0);
}
...
static size_t _MoveXYZW_Result__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ros2_data__action__MoveXYZW_Result(
    full_bounded, 0);
}
...
static size_t _MoveXYZW_Feedback__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ros2_data__action__MoveXYZW_Feedback(
    full_bounded, 0);
}
...
static size_t _MoveXYZW_SendGoal_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ros2_data__action__MoveXYZW_SendGoal_Request(
    full_bounded, 0);
}
...
static size_t _MoveXYZW_SendGoal_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ros2_data__action__MoveXYZW_SendGoal_Response(
    full_bounded, 0);
}
...
static size_t _MoveXYZW_GetResult_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ros2_data__action__MoveXYZW_GetResult_Request(
    full_bounded, 0);
}
...
static size_t _MoveXYZW_GetResult_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ros2_data__action__MoveXYZW_GetResult_Response(
    full_bounded, 0);
}
...
static size_t _MoveXYZW_FeedbackMessage__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ros2_data__action__MoveXYZW_FeedbackMessage(
    full_bounded, 0);
}

...
static rosidl_typesupport_introspection_c__MessageMember MoveXYZW_Goal__rosidl_typesupport_introspection_c__MoveXYZW_Goal_message_member_array[7] = {
  {
    "positionx",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_data__action__MoveXYZW_Goal, speed),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer

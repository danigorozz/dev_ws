...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_data, action, MoveXYZ_SendGoal)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<ros2_data::action::MoveXYZ_SendGoal>();
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_data, action, MoveXYZ_GetResult)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<ros2_data::action::MoveXYZ_GetResult>();
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_action_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__ACTION_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_data, action, MoveXYZ)() {
  return ::rosidl_typesupport_cpp::get_action_type_support_handle<ros2_data::action::MoveXYZ>();
}

...
{
  new (message_memory) ros2_data::msg::JointPose(_init);
}

void JointPose_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros2_data::msg::JointPose *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember JointPose_message_member_array[6] = {
  {
    ...
    offsetof(ros2_data::msg::JointPose, joint1),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_data::msg::JointPose, joint2),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_data::msg::JointPose, joint3),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_data::msg::JointPose, joint4),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_data::msg::JointPose, joint5),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_data::msg::JointPose, joint6),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers JointPose_message_members = {
  ...
  6,  // number of fields
  sizeof(ros2_data::msg::JointPose),
...
{
  return &::ros2_data::msg::rosidl_typesupport_introspection_cpp::JointPose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_data, msg, JointPose)() {
  return &::ros2_data::msg::rosidl_typesupport_introspection_cpp::JointPose_message_type_support_handle;
}

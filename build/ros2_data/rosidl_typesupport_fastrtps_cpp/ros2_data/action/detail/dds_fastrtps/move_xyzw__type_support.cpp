...
{
  return max_serialized_size_MoveXYZW_Goal(full_bounded, 0);
}
...
{
  return max_serialized_size_MoveXYZW_Result(full_bounded, 0);
}
...
{
  return max_serialized_size_MoveXYZW_Feedback(full_bounded, 0);
}
...
{
  return max_serialized_size_MoveXYZW_SendGoal_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_MoveXYZW_SendGoal_Response(full_bounded, 0);
}
...
{
  return max_serialized_size_MoveXYZW_GetResult_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_MoveXYZW_GetResult_Response(full_bounded, 0);
}
...
{
  return max_serialized_size_MoveXYZW_FeedbackMessage(full_bounded, 0);
}

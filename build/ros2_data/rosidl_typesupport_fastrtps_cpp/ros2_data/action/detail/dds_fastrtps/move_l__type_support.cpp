...
{
  return max_serialized_size_MoveL_Goal(full_bounded, 0);
}
...
{
  return max_serialized_size_MoveL_Result(full_bounded, 0);
}
...
{
  return max_serialized_size_MoveL_Feedback(full_bounded, 0);
}
...
{
  return max_serialized_size_MoveL_SendGoal_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_MoveL_SendGoal_Response(full_bounded, 0);
}
...
{
  return max_serialized_size_MoveL_GetResult_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_MoveL_GetResult_Response(full_bounded, 0);
}
...
{
  return max_serialized_size_MoveL_FeedbackMessage(full_bounded, 0);
}

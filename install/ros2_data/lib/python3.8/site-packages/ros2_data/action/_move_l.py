...
class MoveL_Goal(metaclass=Metaclass_MoveL_Goal):
    ...
    def __init__(self, **kwargs):
        ...
        self.movex = kwargs.get('movex', float())
        self.movey = kwargs.get('movey', float())
        self.movez = kwargs.get('movez', float())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.movex != other.movex:
            return False
        if self.movey != other.movey:
            return False
        if self.movez != other.movez:
            return False
    ...
    def movex(self, value):
        if __debug__:
            assert \
                ...
                "The 'movex' field must be of type 'float'"
        self._movex = value
    ...
    def movey(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'movey' field must be of type 'float'"
        self._movey = value
    ...
    def movez(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'movez' field must be of type 'float'"
        self._movez = value
...
class MoveL_SendGoal_Request(metaclass=Metaclass_MoveL_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'ros2_data/MoveL_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['ros2_data', 'action'], 'MoveL_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from ros2_data.action._move_l import MoveL_Goal
...
class Metaclass_MoveL_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ros2_data.action.MoveL_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from ros2_data.action import _move_l
...
class MoveL_SendGoal(metaclass=Metaclass_MoveL_SendGoal):
    from ros2_data.action._move_l import MoveL_SendGoal_Request as Request
    from ros2_data.action._move_l import MoveL_SendGoal_Response as Response
...
class MoveL_GetResult_Response(metaclass=Metaclass_MoveL_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'ros2_data/MoveL_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['ros2_data', 'action'], 'MoveL_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from ros2_data.action._move_l import MoveL_Result
...
class Metaclass_MoveL_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ros2_data.action.MoveL_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveL_GetResult(metaclass=Metaclass_MoveL_GetResult):
    from ros2_data.action._move_l import MoveL_GetResult_Request as Request
    from ros2_data.action._move_l import MoveL_GetResult_Response as Response
...
class Metaclass_MoveL_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ros2_data.action.MoveL_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveL_FeedbackMessage(metaclass=Metaclass_MoveL_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'ros2_data/MoveL_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['ros2_data', 'action'], 'MoveL_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from ros2_data.action._move_l import MoveL_Feedback
...
class MoveL(metaclass=Metaclass_MoveL):
    ...
    from ros2_data.action._move_l import MoveL_Goal as Goal
    # The result message defined in the action definition.
    from ros2_data.action._move_l import MoveL_Result as Result
    # The feedback message defined in the action definition.
    from ros2_data.action._move_l import MoveL_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from ros2_data.action._move_l import MoveL_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from ros2_data.action._move_l import MoveL_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from ros2_data.action._move_l import MoveL_FeedbackMessage as FeedbackMessage

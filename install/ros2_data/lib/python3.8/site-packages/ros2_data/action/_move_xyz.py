...
class MoveXYZ_SendGoal_Request(metaclass=Metaclass_MoveXYZ_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'ros2_data/MoveXYZ_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['ros2_data', 'action'], 'MoveXYZ_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from ros2_data.action._move_xyz import MoveXYZ_Goal
...
class Metaclass_MoveXYZ_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ros2_data.action.MoveXYZ_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from ros2_data.action import _move_xyz
...
class MoveXYZ_SendGoal(metaclass=Metaclass_MoveXYZ_SendGoal):
    from ros2_data.action._move_xyz import MoveXYZ_SendGoal_Request as Request
    from ros2_data.action._move_xyz import MoveXYZ_SendGoal_Response as Response
...
class MoveXYZ_GetResult_Response(metaclass=Metaclass_MoveXYZ_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'ros2_data/MoveXYZ_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['ros2_data', 'action'], 'MoveXYZ_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from ros2_data.action._move_xyz import MoveXYZ_Result
...
class Metaclass_MoveXYZ_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ros2_data.action.MoveXYZ_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveXYZ_GetResult(metaclass=Metaclass_MoveXYZ_GetResult):
    from ros2_data.action._move_xyz import MoveXYZ_GetResult_Request as Request
    from ros2_data.action._move_xyz import MoveXYZ_GetResult_Response as Response
...
class Metaclass_MoveXYZ_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ros2_data.action.MoveXYZ_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveXYZ_FeedbackMessage(metaclass=Metaclass_MoveXYZ_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'ros2_data/MoveXYZ_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['ros2_data', 'action'], 'MoveXYZ_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from ros2_data.action._move_xyz import MoveXYZ_Feedback
...
class MoveXYZ(metaclass=Metaclass_MoveXYZ):
    ...
    from ros2_data.action._move_xyz import MoveXYZ_Goal as Goal
    # The result message defined in the action definition.
    from ros2_data.action._move_xyz import MoveXYZ_Result as Result
    # The feedback message defined in the action definition.
    from ros2_data.action._move_xyz import MoveXYZ_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from ros2_data.action._move_xyz import MoveXYZ_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from ros2_data.action._move_xyz import MoveXYZ_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from ros2_data.action._move_xyz import MoveXYZ_FeedbackMessage as FeedbackMessage
